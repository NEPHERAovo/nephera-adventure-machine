            ...
            <div class="w-auto rotate-45 flex mx-24">
                <div v-for="count in 6">
                    <div v-for="count2 in 6">
                        <div v-bind:id="((count-1)*6+count2).toString()" @click="clickButton((count-1)*6+count2)" v-if="(count==1 && count2<3) || (count==2 && count2<4) || (count==3 && count2>1 && count2<5)
                        ...
                        <div v-bind:id="((count-1)*6+count2).toString()" @click="clickButton((count-1)*6+count2)"
                            v-else-if="(count==1 && count2>=3 && count2<=6) || (count==2 && count2>=4) || (count==3 && count2>=5)
                            || (count==4 && count2==6)"
                        ...
                        <div v-bind:id="((count-1)*6+count2).toString()" @click="clickButton((count-1)*6+count2)" v-else
